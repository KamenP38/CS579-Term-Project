Congressional district boundaries for Colorado from 12/05/11 to 12/31/21 (shapefile)
...
The Congressional district boundaries for 12/05/11 to 12/31/21 were retrieved from https://redistricting.lls.edu/state/colorado

##Processing
The Congressional district boundaries for Colorado were retrieved with a python script. 
...
##Additional Notes
For more information on the data see the AAR page at: https://redistricting.lls.edu/state/colorado
