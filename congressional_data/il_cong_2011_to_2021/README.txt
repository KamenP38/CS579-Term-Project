Congressional district boundaries for Illinois from 06/24/11 to 12/31/21 (shapefile)
...
The Congressional district boundaries for 06/24/11 to 12/31/21 were retrieved from https://redistricting.lls.edu/state/illinois

##Processing
The Congressional district boundaries for Illinois were retrieved with a python script. 
...
##Additional Notes
For more information on the data see the AAR page at: https://redistricting.lls.edu/state/illinois
