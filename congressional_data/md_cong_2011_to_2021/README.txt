Congressional district boundaries for Maryland from 10/20/11 to 12/31/21 (shapefile)
...
The Congressional district boundaries for 10/20/11 to 12/31/21 were retrieved from https://redistricting.lls.edu/state/maryland

##Processing
The Congressional district boundaries for Maryland were retrieved with a python script. 
...
##Additional Notes
For more information on the data see the AAR page at: https://redistricting.lls.edu/state/maryland
