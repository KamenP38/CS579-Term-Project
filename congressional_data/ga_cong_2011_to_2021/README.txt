Congressional district boundaries for Georgia from 12/23/11 to 12/31/21 (shapefile)
...
The Congressional district boundaries for 12/23/11 to 12/31/21 were retrieved from https://redistricting.lls.edu/state/georgia

##Processing
The Congressional district boundaries for Georgia were retrieved with a python script. 
...
##Additional Notes
For more information on the data see the AAR page at: https://redistricting.lls.edu/state/georgia
